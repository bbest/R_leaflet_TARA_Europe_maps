...
# The background leaflet map can be overlaid with bathymetry and chlorophyll-a satellite data.
...
file_paths <- list(
  path_aux_file = "/path/to/station_lat_lon.xlsx",  
  path_to_clim = "/path/to/chl_clim.nc",
  path_to_depth = "/path/to/depth.nc"
)
